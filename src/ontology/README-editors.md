These notes are for the EDITORS of aism-testDec9-2020
...
Make sure you have an ID range in the [idranges file](aism-testDec9-2020-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [aism-testDec9-2020-edit.owl](aism-testDec9-2020-edit.owl)

** DO NOT EDIT aism-testDec9-2020.obo OR aism-testDec9-2020.owl in the top level directory **

[../../aism-testDec9-2020.owl](../../aism-testDec9-2020.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/jcgiron/aism-testDec9-2020) for details.
 ...
 * [aism-testDec9-2020-idranges.owl](aism-testDec9-2020-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/aism-testDec9-2020_terms.txt file
...
Note: the aism-testDec9-2020_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as aism-testDec9-2020.owl and aism-testDec9-2020.obo and places
 ...
 * https://github.com/jcgiron/aism-testDec9-2020/releases
 * https://github.com/jcgiron/aism-testDec9-2020/releases/new
...
what is in the `owl:versionIRI` of the derived aism-testDec9-2020.owl (`data-version` in
aism-testDec9-2020.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/aism-testDec9-2020.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/aism-testDec9-2020/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/jcgiron/aism-testDec9-2020.svg?branch=master)](https://travis-ci.org/jcgiron/aism-testDec9-2020)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/jcgiron](https://travis-ci.org/profile/jcgiron)
 2. click the "Sync account" button
 3. Click the tick symbol next to aism-testDec9-2020
