...
- **Does the term already exist?** Before submitting suggestions for new ontology terms, check whether the term exist, either as a primary term or a synonym term. You can search using [OLS](http://www.ebi.ac.uk/ols/ontologies/aism-testDec9-2020)
...
On behalf of the Insect Skeleto Muscular Anatomy ontology editorial team, Thanks!